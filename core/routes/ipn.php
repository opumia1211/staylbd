...
Route::match(['get','post'], 'bkash', 'Bkash\ProcessController@ipn')->name('Bkash');
Route::post('TZSMMPAY', 'TZSMMPAY\ProcessController@ipn')->name('TZSMMPAY');

// WintersMM IPN route
Route::post('WINTERSMM', 'WINTERSMM\ProcessController@ipn')->name('WINTERSMM');

// PoysaPay (poysapay.com) — callback/redirect after payment
Route::match(['get', 'post'], 'poysapay', 'PoysaPay\ProcessController@ipn')->name('PoysaPay');

...
- Name: language-switch.spec.ts >> language and currency dropdown open aligned on hover
- Location: tests\e2e\language-switch.spec.ts:3:5
...
Call log:
  - waiting for locator('.stayl-topbar-menu:has(#staylCurrentLanguageLabel)').first()
    - locator resolved to <div class="stayl-topbar-menu stayl-topbar-menu--keep-mobile">…</div>
  - attempting hover action
    ...
    - retrying hover action
      - waiting 100ms
    47 × waiting for element to be visible and stable
       - element is visible and stable
       - scrolling into view if needed
       - done scrolling
       - element is outside of the viewport
...
- generic [active] [ref=e1]:
    ...
    - generic [ref=e1267]:
      ...
      - generic [ref=e1290]:
        - combobox [ref=e1294] [cursor=pointer]:
          ...
          - option "#2 realtime?ids=1%2C5%2C4%2C3%2C2 (ajax) (17:11:09)"
  ...
  - generic [ref=e1303]:
    ...
    - generic [ref=e1305]:
      - generic [ref=e1306]:
        - text: Fahim in Narayanganj recently bought
        - text: RIAZUL ISLAM SHOJOL...
      - generic [ref=e1307]: 1 hour ago
```

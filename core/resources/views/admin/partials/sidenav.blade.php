...
<aside id="layout-menu" class="layout-menu-horizontal menu-horizontal menu flex-grow-0">
  <div class="container-xxl d-flex h-100">
    <ul class="menu-inner">
      ...
      <li class="menu-item {{ menuActive(['admin.dashboard', 'admin.security.dashboard', 'admin.business.insights']) ? 'active open' : '' }}">
      ...
      @php
          $homeRoutes = [
              'admin.frontend.sections.homepage', 'admin.frontend.sections.homepageCustomRows*', 'admin.frontend.sections.homepageAds*', 
              'admin.frontend.sections.banner*', 'admin.frontend.sections.scrollbar*', 'admin.product.todayDeal', 'admin.product.hot', 
              'admin.product.feature.index', 'admin.product.trending', 'admin.product.bestSelling', 'admin.frontend.sections.ticker'
          ];
      @endphp
      ...
      @php
          $catalogRoutes = [
              'admin.product*', 'admin.category*', 'admin.subcategory*', 'admin.brand*', 'admin.attributes*', 'admin.coupon*', 'admin.offer-timers*', 'admin.popup-ads*', 'admin.category.attributes*', 'admin.product.topbar.*'
          ];
      @endphp
      <li class="menu-item {{ menuActive($catalogRoutes) ? 'active open' : '' }}">
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item {{ (request()->routeIs('admin.product.index') && request('low_stock')) ? 'active' : '' }}">
      ...
      @php
          $opsRoutes = [
              'admin.orders*', 'admin.abandoned-orders*', 'admin.notifications*', 'admin.setting.stock.order.messages', 
              'admin.shipping*', 'admin.api.courier*', 'admin.locations.*'
          ];
      @endphp
      <li class="menu-item {{ menuActive($opsRoutes) ? 'active open' : '' }}">
        <a href="javascript:void(0)" class="menu-link menu-toggle">
          ...
          @if($pendingOrderCount > 0 || $failedCourierOrders > 0) <span class="badge badge-dot bg-danger ms-2"></span> @endif
        </a>
        <ul class="menu-sub">
          ...
          <li class="menu-item {{ menuActive('admin.orders.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
              <li class="menu-item {{ menuActive('admin.orders.pending') }}"><a href="{{ route('admin.orders.pending') }}" class="menu-link">@lang('Pending') @if($pendingOrderCount) <span class="badge bg-danger ms-auto">{{ $pendingOrderCount }}</span> @endif</a></li>
              <li class="menu-item {{ menuActive('admin.orders.confirmed') }}"><a href="{{ route('admin.orders.confirmed') }}" class="menu-link">@lang('Confirmed')</a></li>
              <li class="menu-item {{ menuActive('admin.orders.processing') }}"><a href="{{ route('admin.orders.processing') }}" class="menu-link">@lang('Processing')</a></li>
              <li class="menu-item {{ menuActive('admin.orders.packaging') }}"><a href="{{ route('admin.orders.packaging') }}" class="menu-link">@lang('Packaging')</a></li>
              <li class="menu-item {{ menuActive('admin.orders.shipped') }}"><a href="{{ route('admin.orders.shipped') }}" class="menu-link">@lang('Shipped')</a></li>
              <li class="menu-item {{ menuActive('admin.orders.delivered') }}"><a href="{{ route('admin.orders.delivered') }}" class="menu-link">@lang('Delivered')</a></li>
              <li class="menu-item {{ menuActive('admin.orders.cancel') }}"><a href="{{ route('admin.orders.cancel') }}" class="menu-link">@lang('Canceled')</a></li>
            </ul>
          </li>
          ...
          <li class="menu-item {{ menuActive('admin.shipping.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
              <li class="menu-item {{ menuActive('admin.shipping.index') }}"><a href="{{ route('admin.shipping.index') }}" class="menu-link">@lang('Shipping Hub')</a></li>
              <li class="menu-item {{ menuActive('admin.shipping.zones*') }}"><a href="{{ route('admin.shipping.zones.index') }}" class="menu-link">@lang('Zones')</a></li>
              <li class="menu-item {{ menuActive('admin.shipping.methods*') }}"><a href="{{ route('admin.shipping.methods.index') }}" class="menu-link">@lang('Methods')</a></li>
              <li class="menu-item {{ menuActive('admin.shipping.rules*') }}"><a href="{{ route('admin.shipping.rules.index') }}" class="menu-link">@lang('Rules')</a></li>
              <li class="menu-item {{ menuActive('admin.shipping.cod.index') }}"><a href="{{ route('admin.shipping.cod.index') }}" class="menu-link">@lang('COD Settings')</a></li>
            </ul>
          </li>
          <li class="menu-item {{ menuActive('admin.api.courier.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
              <li class="menu-item {{ menuActive('admin.api.courier.manage') }}"><a href="{{ route('admin.api.courier.manage') }}" class="menu-link">@lang('Courier Settings')</a></li>
              ...
              <li class="menu-item {{ menuActive('admin.api.courier.*') ? 'active' : '' }}"><a href="{{ route('admin.orders.bulk.courier', 'pathao') }}" class="menu-link">@lang('Bulk') (Pathao)</a></li>
              <li class="menu-item {{ menuActive('admin.api.courier.*') ? 'active' : '' }}"><a href="{{ route('admin.orders.bulk.courier', 'steadfast') }}" class="menu-link">@lang('Bulk') (Steadfast)</a></li>
              @endif
              <li class="menu-item {{ menuActive('admin.api.courier.logs') }}"><a href="{{ route('admin.api.courier.logs') }}" class="menu-link">@lang('Courier Logs') @if($failedCourierOrders > 0) <span class="badge bg-danger ms-auto">{{ $failedCourierOrders }}</span> @endif</a></li>
              <li class="menu-item {{ menuActive('admin.api.courier.reports') }}"><a href="{{ route('admin.api.courier.reports') }}" class="menu-link">@lang('Courier Reports')</a></li>
            </ul>
          </li>
      ...
      @php
          $financeRoutes = [
              'admin.gateway*', 'admin.deposit*', 'admin.payment.*'
          ];
      @endphp
      <li class="menu-item {{ menuActive($financeRoutes) ? 'active open' : '' }}">
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item {{ menuActive('admin.gateway.automatic.*') }}"><a href="{{ route('admin.gateway.automatic.index') }}" class="menu-link">@lang('Automatic')</a></li>
          <li class="menu-item {{ menuActive('admin.gateway.manual.*') }}"><a href="{{ route('admin.gateway.manual.index') }}" class="menu-link">@lang('Manual')</a></li>
          <li class="menu-item {{ menuActive('admin.gateway.autopay.*') }}"><a href="{{ route('admin.gateway.autopay.index') }}" class="menu-link">@lang('Autopay')</a></li>
          <li class="menu-item-header small text-muted text-uppercase py-2 px-3">@lang('Payment History')</li>
          <li class="menu-item {{ menuActive('admin.deposit.list') }}"><a href="{{ route('admin.deposit.list') }}" class="menu-link">@lang('All Payments')</a></li>
          <li class="menu-item {{ menuActive('admin.deposit.pending') }}"><a href="{{ route('admin.deposit.pending') }}" class="menu-link">@lang('Pending') @if($pendingDepositsCount) <span class="badge bg-danger ms-auto">{{ $pendingDepositsCount }}</span> @endif</a></li>
          <li class="menu-item {{ menuActive('admin.deposit.approved') }}"><a href="{{ route('admin.deposit.approved') }}" class="menu-link">@lang('Approved')</a></li>
          <li class="menu-item {{ menuActive('admin.deposit.successful') }}"><a href="{{ route('admin.deposit.successful') }}" class="menu-link">@lang('Successful')</a></li>
          <li class="menu-item {{ menuActive('admin.deposit.rejected') }}"><a href="{{ route('admin.deposit.rejected') }}" class="menu-link">@lang('Rejected')</a></li>
          <li class="menu-item {{ menuActive('admin.deposit.initiated') }}"><a href="{{ route('admin.deposit.initiated') }}" class="menu-link">@lang('Initiated')</a></li>
        </ul>
      </li>
      ...
      @php
          $supportRoutes = [
              'admin.users*', 'admin.subscriber*', 'admin.ticket*', 'admin.autoai*', 'admin.notifications', 'admin.contact.channels.*'
          ];
      @endphp
      <li class="menu-item {{ menuActive($supportRoutes) ? 'active open' : '' }}">
        <a href="javascript:void(0)" class="menu-link menu-toggle">
          ...
          @if($pendingTicketCount > 0 || $bannedUsersCount > 0) <span class="badge badge-dot bg-danger ms-2"></span> @endif
        </a>
        <ul class="menu-sub">
          <li class="menu-item {{ menuActive('admin.users.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
              <li class="menu-item {{ menuActive('admin.users.all') }}"><a href="{{ route('admin.users.all') }}" class="menu-link">@lang('All Customers')</a></li>
              <li class="menu-item {{ menuActive('admin.users.active') }}"><a href="{{ route('admin.users.active') }}" class="menu-link">@lang('Active Customers')</a></li>
              <li class="menu-item {{ menuActive('admin.users.banned') }}"><a href="{{ route('admin.users.banned') }}" class="menu-link">@lang('Banned Customers')</a></li>
              <li class="menu-item {{ menuActive('admin.users.email.unverified') }}"><a href="{{ route('admin.users.email.unverified') }}" class="menu-link">@lang('Email Unverified')</a></li>
              <li class="menu-item {{ menuActive('admin.users.mobile.unverified') }}"><a href="{{ route('admin.users.mobile.unverified') }}" class="menu-link">@lang('SMS Unverified')</a></li>
              <li class="menu-item {{ menuActive('admin.users.with.balance') }}"><a href="{{ route('admin.users.with.balance') }}" class="menu-link">@lang('With Balance')</a></li>
            </ul>
          </li>
          ...
          <li class="menu-item {{ menuActive('admin.ticket.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
              <li class="menu-item {{ menuActive('admin.ticket.index') }}"><a href="{{ route('admin.ticket.index') }}" class="menu-link">@lang('All Tickets')</a></li>
              <li class="menu-item {{ menuActive('admin.ticket.pending') }}"><a href="{{ route('admin.ticket.pending') }}" class="menu-link">@lang('Pending') @if($pendingTicketCount) <span class="badge bg-danger ms-auto">{{ $pendingTicketCount }}</span> @endif</a></li>
              <li class="menu-item {{ menuActive('admin.ticket.answered') }}"><a href="{{ route('admin.ticket.answered') }}" class="menu-link">@lang('Answered')</a></li>
              <li class="menu-item {{ menuActive('admin.ticket.closed') }}"><a href="{{ route('admin.ticket.closed') }}" class="menu-link">@lang('Closed')</a></li>
            </ul>
          </li>
      ...
      @php
          $reportRoutes = [
              'admin.report*', 'admin.report.activity.*'
          ];
      @endphp
      <li class="menu-item {{ menuActive($reportRoutes) ? 'active open' : '' }}">
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item {{ menuActive('admin.report.activity.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
              <li class="menu-item {{ menuActive('admin.report.activity.dashboard') }}"><a href="{{ route('admin.report.activity.dashboard') }}" class="menu-link">@lang('Dashboard')</a></li>
              <li class="menu-item {{ menuActive('admin.report.activity.search') }}"><a href="{{ route('admin.report.activity.search') }}" class="menu-link">@lang('Search Activity')</a></li>
              <li class="menu-item {{ menuActive('admin.report.activity.product_views') }}"><a href="{{ route('admin.report.activity.product_views') }}" class="menu-link">@lang('Product Views')</a></li>
              <li class="menu-item {{ menuActive('admin.report.activity.cart') }}"><a href="{{ route('admin.report.activity.cart') }}" class="menu-link">@lang('Cart Activity')</a></li>
              <li class="menu-item {{ menuActive('admin.report.activity.wishlist') }}"><a href="{{ route('admin.report.activity.wishlist') }}" class="menu-link">@lang('Wishlist Activity')</a></li>
              <li class="menu-item {{ menuActive('admin.report.activity.compare') }}"><a href="{{ route('admin.report.activity.compare') }}" class="menu-link">@lang('Compare Activity')</a></li>
              <li class="menu-item {{ menuActive('admin.report.activity.orders') }}"><a href="{{ route('admin.report.activity.orders') }}" class="menu-link">@lang('Order History')</a></li>
              <li class="menu-item {{ menuActive('admin.report.activity.track_order') }}"><a href="{{ route('admin.report.activity.track_order') }}" class="menu-link">@lang('Track Search')</a></li>
              <li class="menu-item {{ menuActive('admin.report.activity.payments') }}"><a href="{{ route('admin.report.activity.payments') }}" class="menu-link">@lang('Payment Activity')</a></li>
              <li class="menu-item {{ menuActive('admin.report.activity.login') }}"><a href="{{ route('admin.report.activity.login') }}" class="menu-link">@lang('Login Tracking')</a></li>
              <li class="menu-item {{ menuActive('admin.report.activity.live') }}"><a href="{{ route('admin.report.activity.live') }}" class="menu-link">@lang('Live Monitor')</a></li>
              <li class="menu-item {{ menuActive('admin.report.activity.suspicious') }}"><a href="{{ route('admin.report.activity.suspicious') }}" class="menu-link">@lang('Suspicious Activity')</a></li>
            </ul>
          </li>
      ...
      @php
          $settingsRoutes = [
              'admin.setting*', 'admin.extensions*', 'admin.language*', 'admin.seo*', 'admin.ui.settings', 'admin.theme.settings'
          ];
      @endphp
      ...
      @php
          $finalRoutes = [
              'admin.frontend.sections*', 'admin.maintenance*', 'admin.system*', 'admin.setting.custom.css', 'admin.request.report', 'admin.setting.cookie', 'admin.frontend.templates', 'admin.frontend.quickorder'
          ];
      @endphp
      <li class="menu-item {{ menuActive($finalRoutes) ? 'active open' : '' }}">
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item {{ menuActive('admin.frontend.sections.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
              <li class="menu-item {{ menuActive('admin.frontend.sections.general') }}"><a href="{{ route('admin.frontend.sections.general') }}" class="menu-link">@lang('General')</a></li>
              <li class="menu-item {{ menuActive('admin.frontend.sections.userprofile') }}"><a href="{{ route('admin.frontend.sections.userprofile') }}" class="menu-link">@lang('User Profile Control')</a></li>
              <li class="menu-item {{ menuActive('admin.frontend.quickorder') }}"><a href="{{ route('admin.frontend.quickorder') }}" class="menu-link">@lang('Quick Order Page')</a></li>
          ...
          <li class="menu-item {{ menuActive(['admin.maintenance.*', 'admin.system.*']) ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
              <li class="menu-item {{ menuActive('admin.maintenance.dashboard') }}"><a href="{{ route('admin.maintenance.dashboard') }}" class="menu-link">@lang('Maintenance Hub')</a></li>
              <li class="menu-item {{ menuActive('admin.system.info') }}"><a href="{{ route('admin.system.info') }}" class="menu-link">@lang('Application Info')</a></li>
              <li class="menu-item {{ menuActive('admin.system.server.info') }}"><a href="{{ route('admin.system.server.info') }}" class="menu-link">@lang('Server Information')</a></li>
              <li class="menu-item {{ menuActive('admin.system.optimize') }}"><a href="{{ route('admin.system.optimize') }}" class="menu-link">@lang('Cache Manager')</a></li>
            </ul>
          </li>

@php
    ...
    $allowPixels = feature_enabled('assets.allow_marketing_pixels', false);
@endphp

{{-- Google Analytics 4 --}}
@if(!$libraryOnly && $allowPixels && $general->ga4_id)
...
{{-- Facebook Pixel --}}
@if(!$libraryOnly && $allowPixels && $general->fb_pixel_id)
<script>
...
@if(!$libraryOnly && $allowPixels && $general->tt_pixel_id)
<script>
!function (w, d, t) {

...
@endphp
<section class="pro-section pro-section--tight social-proof-section">
    <div class="container-fluid px-3 px-lg-4">
        ...
        <div class="social-proof-reviews-slider flex gap-4 overflow-x-auto pb-2 [-webkit-overflow-scrolling:touch] snap-x snap-mandatory [scrollbar-width:thin]">
            @foreach($reviews as $review)
                <div class="social-proof-review-item card h-100 min-w-[260px] max-w-[320px] shrink-0 snap-start border-0 shadow-sm">
                    <div class="card-body">
        ...
        @if(($settings->top_rated_enabled ?? 1) && $topRatedProducts->isNotEmpty())
            @include($activeTemplate . 'partials.product_carousel_section', [
                ...
                'sectionClass' => 'pro-section pro-section--tight social-proof-section pro-section__head-gap',
                'sectionId' => 'top-rated',
            ])
        @endif
    </div>

                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text">@include($activeTemplate . 'partials.icon', ['name' => 'font'])</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text">@include($activeTemplate . 'partials.icon', ['name' => 'credit-card'])</span>
                                </div>
                            </div>
                        </div>

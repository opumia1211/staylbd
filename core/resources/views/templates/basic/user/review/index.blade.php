                            ...
                            <tr id="tr_{{ $product->id }}" class="dashboard-compact-row">
                                ...
                                <td class="py-2 pe-2 align-middle">
                                    <div class="product-list-row__action-btns d-flex flex-wrap gap-1 justify-content-end">
                                        ...
                                        <a href="{{ route('cart.list.buy.now', $product->id) }}" class="product-list-row__btn product-list-row__btn--buy btn btn-sm btn-review-action" title="@lang('Buy Now')" data-no-ajax>@include($activeTemplate . 'partials.icon', ['name' => 'bolt'])</a>

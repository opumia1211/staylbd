...
@section('dashboard_page_title')
    @include($activeTemplate . 'partials.dashboard_page_header', ['title' => __($pageTitle), 'subtitle' => __('Enter your order number below to see current status and where your product is')])
@endsection
@section('content')
<div class="track-order-outer-wrap">
    <div class="track-order-page dashboard-content--center" role="region" aria-label="@lang('Track Your Order')">
...
(function($) {
    ...
    $('#trackOrderForm').on('submit', function(e) { e.preventDefault(); doTrack($('#track_order_no').val()); });

...
class ManualGatewayController extends Controller
{
    public function index()
    {
        ...
        $gateways = Gateway::manual()->with('singleCurrency')->orderBy('id','desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        $method->gateway_parameters = json_encode(['region' => $request->input('region', '')]);
        ...
        $gatewayCurrency->symbol = $request->input('symbol', '');
    ...
    public function update(Request $request, $code)
    {
        ...
        $singleCurrency->symbol = $request->input('symbol', '');

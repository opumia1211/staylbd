@php
    try {
        $tracking = app(\App\Modules\Tracking\TrackingScriptService::class);
    } catch (\Throwable $e) {
        $tracking = null;
    }
@endphp
@if($tracking && $tracking->hasAny())
    {{-- Meta Pixel (browser) --}}
    ...
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id={{ $tracking->metaPixelId() }}&ev=PageView&noscript=1" alt="" /></noscript>
    @endif
    {{-- Google Ads (gtag) --}}
